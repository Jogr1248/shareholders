...
function DepositHistory({ shareholderId }: { shareholderId: string }) {
  ...
  if (loading) return <p className="text-gray-500">Loading deposits...</p>;
  if (deposits.length === 0) return <p className="text-gray-500 italic">No deposits recorded yet.</p>;
    ...
    <Dialog open={isModalOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{title}</DialogTitle>
          <DialogDescription>
            {isEdit ? "Update shareholder information" : "Register a new shareholder"}
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <InputShareholderId editSample={editSample} />
          <InputAction isEdit={isEdit} />
          <InputName_english editSample={editSample} />
          <InputName_amharic editSample={editSample} />
          <InputGender editSample={editSample} />
          <InputNationality editSample={editSample} />
          <InputBirthDateAmharic editSample={editSample} />
          <InputBirthDateEnglish editSample={editSample} />
          <InputNationalIdNum editSample={editSample} />
          <InputPassportNum editSample={editSample} />
          <InputTinNum editSample={editSample} />
          <InputResidencyStatus editSample={editSample} />
          <InputCity editSample={editSample} />
          <InputSub_city editSample={editSample} />
          <InputWereda editSample={editSample} />
          <InputHouse_number editSample={editSample} />
          <InputPrimary_phone editSample={editSample} />
          <InputSecondary_phone editSample={editSample} />
          <InputEmail editSample={editSample} />
          <InputDividendBankName editSample={editSample} />
          <InputDividendBankAccount editSample={editSample} />
          <InputSubscribedShare editSample={editSample} />
          <InputReceiptNum editSample={editSample} />
          <InputCertificateNum editSample={editSample} />
          <InputIsCertificateTaken editSample={editSample} />
          <InputMedinaComment editSample={editSample} />
          <InputGeneralComment editSample={editSample} />
          ...
          {isEdit && editSample && (
            <div className="mt-12 pt-8 border-t-4 border-dashed border-gray-300">
              ...
              <div className="mt-10 bg-green-50 p-8 rounded-xl">
                <h4 className="text-xl font-semibold mb-6 text-green-800">
                  + Record New Deposit
                </h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block font-medium mb-2">Deposit Date</label>
                    <input
                      type="date"
                      name="deposit_date"
                      required
                  ...
                  <div>
                    ...
                    <select name="payment_method" required className="w-full border rounded-lg px-4 py-3">
                ...
                <button
                  ...
                  className="mt-8 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-4 rounded-lg disabled:opacity-50"
                >
